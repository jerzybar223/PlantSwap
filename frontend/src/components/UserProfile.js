  ...
  return (
    <div style={{ minHeight: "100vh", background: "#ededed" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", alignItems: "flex-start", gap: 40, marginTop: 50 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 30, minWidth: 320, alignItems: "flex-end", marginTop: 0 }}>
          <div style={{ width: 260, background: "#d6d6d6", borderRadius: 40, padding: "32px 0", display: "flex", flexDirection: "column", alignItems: "stretch", boxShadow: "0 2px 8px #bbb" }}>
            <button
              style={{
                background: view === "profile" ? "#bfc0c5" : "#ededed",
                color: view === "profile" ? "#fff" : "#888",
                fontSize: 28,
                border: "none",
                borderRadius: 30,
                padding: "16px 0",
            ...
            <button
              style={{
                background: view === "edit" ? "#bfc0c5" : "#ededed",
                color: view === "edit" ? "#fff" : "#888",
                fontSize: 28,
                border: "none",
                borderRadius: 30,
                padding: "16px 0",
            ...
            <button
              style={{
                background: view === "addPlant" ? "#bfc0c5" : "#ededed",
                color: view === "addPlant" ? "#fff" : "#888",
                fontSize: 28,
                border: "none",
                borderRadius: 30,
                padding: "16px 0",
            ...
            <button
              style={{
                background: view === "swaps" ? "#bfc0c5" : "#ededed",
                color: view === "swaps" ? "#fff" : "#888",
                fontSize: 28,
                border: "none",
                borderRadius: 30,
                padding: "16px 0",
        ...
        <div style={{ flex: 1, minWidth: 600 }}>
          {view === "profile" && (
            <div style={{ background: "#d6d6d6", borderRadius: 60, padding: 40, boxShadow: "0 2px 8px #bbb" }}>
          ...
          {view === "edit" && (
            <div style={{ maxWidth: 600, margin: "0 auto", background: "#fff", borderRadius: 24, boxShadow: "0 2px 8px #bbb", padding: 32 }}>
          ...
          {view === "swaps" && (
            <div style={{ maxWidth: 700, margin: "0 auto", background: "#fff", borderRadius: 24, boxShadow: "0 2px 8px #bbb", padding: 32 }}>
